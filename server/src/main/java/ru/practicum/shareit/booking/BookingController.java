...
public class BookingController {
    ...
    public ResponseEntity<BookingOutputDto> createBooking(
        ...
        log.info("Create ru.practicum.shareit.booking {}", userId);
    ...
    public ResponseEntity<BookingOutputDto> approve(
            ...
            @RequestHeader("X-Sharer-User-Id") Long userId) {
        log.info("Approve ru.practicum.shareit.booking id = {}, approved: {}", bookingId, approved);
        return ResponseEntity.ok(bookingService.approveBooking(userId, bookingId, approved));
    }

    @GetMapping("/{bookingId}")
    public ResponseEntity<BookingOutputDto> getBookingById(@PathVariable Long bookingId,
                                                           @RequestHeader("X-Sharer-User-Id") Long userId) {
        log.info("Get ru.practicum.shareit.booking by id {}", bookingId);
